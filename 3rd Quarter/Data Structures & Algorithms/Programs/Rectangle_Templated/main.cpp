...
int Rectangle<int, double>::numberOfRectangles = 0;
...
void main() {
	...
	Rectangle<int,double> r1;
	Rectangle<int,double> r2(2);
	Rectangle<int,double> r3(2, 3);
	Rectangle<int,double> r4(2, 3);
	Rectangle<int,double> r5(5, 6);
	Rectangle<int,double> r6(2, 3);
	Rectangle<int,double> r7(5, 6);
	Rectangle<int,double> r8(5, 6);
	Rectangle<int,double> r9(5, 6);
	
	cout << "Constructor test" << endl;
	cout << "There are 9 Rectangles, are there ? -> " << Rectangle<int,double>::numberOfRectangles << endl;
	...
	*/
	...
	cout << "There are 9 Rectangles, are there ? -> " << Rectangle<int, double>::numberOfRectangles << endl << endl;
