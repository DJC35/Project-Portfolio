...
// TODO current problem is stuck in blind canyon
		...
		switch(direction) {
			...
			case DOWN:
				...
				if(currentRow +1 < maxRows && maze[currentRow +1][currentColumn] == '_'  && maze[currentRow +1][currentColumn] != '.'){
					// ok to move
					numberOfDirectionChanges = 0;										// sence you were able to move 
					maze[currentRow][currentColumn]	= '.';								// leave your cookie crumb	
	...
	// I assume here tat the maze was solve able (spelling is optional today)
	cout << "You did it MOTO!!!" << endl;
	system("pause");
